...
def getlakestimeseries_get(feature, feature_id, start_time, end_time, output, fields) -> object:  # noqa: E501
...
def lambda_handler(event, context):
    ...
    results = getlakestimeseries_get(feature, feature_id, start_time, end_time, output, fields)
