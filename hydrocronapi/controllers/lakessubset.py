...
def getlakessubset_get(feature, subsetpolygon, start_time, end_time, output, fields):  # noqa: E501
...
def lambda_handler(event, context):
    ...
    results = getlakessubset_get(feature, subsetpolygon, start_time, end_time, output, fields)
