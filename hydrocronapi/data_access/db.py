...
class DynamoDataRepository:
    ...
    def get_reach_series_by_feature_id(self, feature_id: str, start_time: datetime, end_time: datetime) -> Generator:
    ...
    def get_node_series_by_feature_id(self, feature_id, start_time, end_time):
